...
## Corpus Check
- 133 files · ~1,180,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 481 nodes · 703 edges · 52 communities (33 shown, 19 thin omitted)
- Extraction: 97% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.81)
...
1. `Pre-Benchmark Validation Report` - 18 edges
2. `msgraphrag settings` - 14 edges
3. `main()` - 13 edges
4. `main()` - 13 edges
5. `main()` - 13 edges
6. `main()` - 13 edges
...
Cohesion: 0.20
Nodes (9): Conclusion, Evidence Paths, KAG Automatic Builder Validation, Key Observations, Question Outcomes, Run Metadata, Scope, Validation Metrics (+1 more)
...
## Knowledge Gaps
- **129 isolated node(s):** `$schema`, `type`, `required`, `type`, `type` (+124 more)
...
- **Should `Question Schema Evidence` be split into smaller, more focused modules?**
